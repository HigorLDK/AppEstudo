...
import com.example.appestudo.ui.screens.home.TelaHome
import com.example.appestudo.ui.screens.outros.TelaPerfil
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(BottomItem.HOME.route) {
                TelaHome(rootNavController)
            }
            /*composable(BottomItem.VACINA.route) {
                ProntuarioPetScreen()
            }*/
            composable(BottomItem.PERFIL.route) {
                TelaPerfil(rootNavController)
            }
        }
    }
}